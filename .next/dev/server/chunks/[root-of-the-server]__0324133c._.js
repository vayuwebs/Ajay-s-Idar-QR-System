...
async function POST(req) {
    try {
        ...
        const { data: session, error: sessionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("sessions").select("status, table_id").eq("id", sessionId).single();
        ...
        const { error: closeSessionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("sessions").update({
            status: "closed",
            ended_at: new Date().toISOString()
        }).eq("id", sessionId);
        if (closeSessionError) throw closeSessionError;
        // 3. Free up the Table
        const { error: freeTableError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("tables").update({
            status: "free",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0324133c._.js.map