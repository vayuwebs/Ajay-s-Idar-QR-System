...
export default function ForgotPassword() {
    ...
    const handleSendOTP = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            setSuccess(true);
            // Save email in local storage so verify page knows who is trying to reset
            ...
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                {success ? (
                    <div className="text-center">
                        ...
                        <Link
                            href="/admin/login/verify-otp"
                            className="inline-block w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-4 rounded-lg transition"
                        >
